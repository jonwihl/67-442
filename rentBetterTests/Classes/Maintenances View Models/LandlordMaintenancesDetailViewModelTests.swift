...
class LandlordMaintenancesDetailViewModelTests: XCTestCase {
    ...
    func test_title() {
			let main = Maintenance(id: 1, title: "Sink not running", description: "no water is coming out of the kitchen sink", created_on: "10/15/2018", closed_on: "10/20/2018", photo: "xyz", active: true)
